...
dcm2::dcm2(show_sql *sql,const QString& tableName,QWidget *parent)
    : QWidget{parent},my_sql(sql),m_tableName(tableName)
{
    ...
    connect(timer_generate_Current,&QTimer::timeout,this,&dcm2::Current_onTimeout);
    connect(timer_generate_Voice,&QTimer::timeout,this,&dcm2::Voice_onTimeout);
    connect(timer_generate_Vibration,&QTimer::timeout,this,&dcm2::Vibration_onTimeout);
...
void dcm2::ChanneSelectInit()
{
    ...
    connect(CurrentButton, &QPushButton::clicked, this, &dcm2::Current_Data);
    ...
    connect(VoiceButton, &QPushButton::clicked, this, &dcm2::Voice_Data);
    ...
    connect(VibrationButton, &QPushButton::clicked, this, &dcm2::Vibration_Data);
...
void dcm2::InitButton()
{
    ...
    connect(Running_Button_Time, &QPushButton::clicked, this, &dcm2::Running_Button_Time_Clicked);

    Running_Button_Fre = new QPushButton(this);
    Running_Button_Fre->setText("频域数据暂停");
    ButtonLayout->addWidget(Running_Button_Fre);
    connect(Running_Button_Fre, &QPushButton::clicked, this, &dcm2::Running_Button_Fre_Clicked);
    ...
    connect(sampleRateButton, &QPushButton::clicked, this, &dcm2::ToggleSampleRate);
    ...
    connect(fftSizeButton, &QPushButton::clicked, this, &dcm2::ToggleFFTSize);
...
void dcm2::Running_Button_Time_Clicked() {
...
void dcm2::Running_Button_Fre_Clicked()
{
...
void dcm2::performFFT(const QVector<double>& data, int n, double cutoffFre)
{
    // 参数检查
    if ((n & (n - 1)) != 0 || n <= 0) {
