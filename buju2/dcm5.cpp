...
dcm5::dcm5(show_sql *sql,const QString& tableName,QWidget *parent)
    : QWidget{parent},my_sql(sql),m_tableName(tableName)
{
    ...
    connect(timer_generate_Current,&QTimer::timeout,this,&dcm5::Current_onTimeout);
    connect(timer_generate_Voice,&QTimer::timeout,this,&dcm5::Voice_onTimeout);
    connect(timer_generate_Vibration,&QTimer::timeout,this,&dcm5::Vibration_onTimeout);
...
void dcm5::ChanneSelectInit()
{
    ...
    connect(CurrentButton, &QPushButton::clicked, this, &dcm5::Current_Data);
    ...
    connect(VoiceButton, &QPushButton::clicked, this, &dcm5::Voice_Data);
    ...
    connect(VibrationButton, &QPushButton::clicked, this, &dcm5::Vibration_Data);
...
void dcm5::InitButton()
{
    ...
    connect(Running_Button_Time, &QPushButton::clicked, this, &dcm5::Running_Button_Time_Clicked);

    Running_Button_Fre = new QPushButton(this);
    Running_Button_Fre->setText("频域数据暂停");
    ButtonLayout->addWidget(Running_Button_Fre);
    connect(Running_Button_Fre, &QPushButton::clicked, this, &dcm5::Running_Button_Fre_Clicked);
    ...
    connect(sampleRateButton, &QPushButton::clicked, this, &dcm5::ToggleSampleRate);
    ...
    connect(fftSizeButton, &QPushButton::clicked, this, &dcm5::ToggleFFTSize);
...
void dcm5::Running_Button_Time_Clicked() {
...
void dcm5::Running_Button_Fre_Clicked()
{
...
void dcm5::performFFT(const QVector<double>& data, int n, double cutoffFre)
{
    // 参数检查
    if ((n & (n - 1)) != 0 || n <= 0) {
